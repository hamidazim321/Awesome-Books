...
**Awesome Books** is the first project in Module 2 of Microverse Full Stack Program. It allows users to keep a list of books and add and remove books from the list
...
- **Keeps data in local storage on browser**
...
- I would like to thank my coding partner Suleiman
